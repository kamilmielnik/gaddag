...
- a [`Gaddag`](docs/classes/Gaddag.md) is immutable — to change the dictionary, build a new one with [`buildGaddag`](docs/functions/buildGaddag.md)
...
Build a [`Gaddag`](docs/classes/Gaddag.md) from a word list (any order, duplicates allowed) with [`buildGaddag`](docs/functions/buildGaddag.md) and use its methods.

### Example

```TypeScript
import { buildGaddag, Gaddag } from '@kamilmielnik/gaddag';
